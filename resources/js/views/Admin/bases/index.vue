            ...
            <a-table
                ...
                <template slot="title" slot-scope="currentPageData">
                    ...
                    <div class="admin_table_handle_btn">
                        <a-button @click="$router.push('/Admin/bases/form')" type="primary" icon="plus">添加</a-button>
                ...
                <span slot="action" slot-scope="rows">
                    <a-button icon="edit" @click="$router.push('/Admin/bases/form/'+rows.id)">编辑</a-button>
                </span>
            </a-table>
