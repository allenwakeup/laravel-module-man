...
class CreateFactoryTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('man_factories', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->unsignedInteger ('base_id')->nullable (false)->default (0)->comment ('生产基地');
    ...
    {
        Schema::dropIfExists('man_factories');
    }
}
